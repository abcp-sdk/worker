...
# xa11y computer-use CLI (Windows build). Built by scripts/build-xa11y.sh
# --windows; the guest boot-fetches it from nginx :8090/xa11y.exe.
XA11Y_BIN="${XA11Y_BIN:-${ROOT}/dist/xa11y-windows-amd64.exe}"
