#!/usr/bin/env node
/*
 * agent-worker Android screen bridge (X11-free, view-only).
 *
 ...
 * the device, run adb through agent-worker's own API, e.g.
 *
 *   agent-worker Execute: adb -s emulator-5554 shell input tap 540 1200
